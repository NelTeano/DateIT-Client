...
import { User, Camera, Edit2, Save, X, LogOut, Heart, MessageCircle, Settings } from 'lucide-react';
    ...
    try {
      const response = await fetch('http://localhost:3100/api/auth/profile', {
        ...
        headers: {
          ...
          'Authorization': `Bearer YOUR_TOKEN_HERE` // Replace with actual token from storage
        },
      });
